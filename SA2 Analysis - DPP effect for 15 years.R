...
# Type 2 Diabetes
# Death
#SA2: Effect maintained for 3 years (HR 0.800), and then reduced to (HR: 0.883) for the following 7 years, then reduced to (HR: 0.907) for the following 5 years then nothing
######################################## 
...
p_matrix_cycle <- function(p_matrix, age, cycle,
  ...
  effect_lookup <-
    c("(0,3]" = rlnorm(1, meanlog = -0.22314, sdlog = 0.044757),
      ...
      "(10,15]"= rlnorm(1, meanlog = -0.0977, sdlog = 0.0395),
