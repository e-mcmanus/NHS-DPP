...
# Type 2 Diabetes
# Death
#SA3: Using costs estimates used in Roberts et.al (18) inflated to 2020 price year
######################################## 
...
#Cost of states
cNorm <- rgamma(1, 56.72487733, scale=15.04595585)
cNDH <- rgamma(1,  69.06768914, scale=13.8917345)
cT2D <- rgamma(1,  58.15501341, scale=39.09155663)
cDeath <- 0
cDPP <- 0
...
#only cost associated with death  - no cost to death in this model
trans_c_matrix <-
