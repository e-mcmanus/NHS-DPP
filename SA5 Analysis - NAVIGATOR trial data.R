...
# Type 2 Diabetes
# Death
#SA5: NAVIGATOR trial data (44) (n=4,661 participants in placebo arm) used as parameter source in Leal (43)
######################################## 
...
#only cost associated with death - no cost of death in this model
trans_c_matrix <-
...
p_matrix_cycle <- function(p_matrix, age, cycle,
  ...
  tpProgT2D_lookup <-
    c("[30,39]" = rbeta(1,80.4, 919.6),
      "[40,49]" = rbeta(1,80.4, 919.6),
      "[50,59]" = rbeta(1,80.4, 919.6),
      "[60,69]" = rbeta(1,80.4, 919.6),
      "[70,79]" = rbeta(1,80.4, 919.6),
      "[80,120]" = rbeta(1,80.4, 919.6))
...
for(n in 1:n_trials) {
  ...
  for (i in 1:n_treatments) {
    ...
    for (j in 2:n_cycles) {
      ...
      #Transition costs - none in this model
